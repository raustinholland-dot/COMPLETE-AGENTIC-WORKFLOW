...
Run these in parallel — they are on the MBP at `100.122.212.128` via Tailscale/SSH (ssh alias `mbp`):
...
- Any unresolved thread from the most recent decision file(s)
